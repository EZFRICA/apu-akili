...
through native OpenAI tool calls (Method A, see docs/decisions.md): apu.runtime.agent offers WEB_SEARCH_TOOL only on validated turns, and
...
# OpenAI tool schema offered to the tutor model on validated turns.
WEB_SEARCH_TOOL = {
    "type": "function",
    "function": {
