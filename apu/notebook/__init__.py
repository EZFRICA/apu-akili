"""The student notebook: what the student chose to keep, and their braille revision sheets.
...
choice: the full answer, its key points (condensed by the tutor model), or an excerpt they pick.
Braille is then generated from the notebook: the entries the student selects, as written,
or a revision summary of them written by the tutor model.
