...
class TurnOutcome(StrEnum):
    ON_TOPIC = "on_topic"
    OFF_TOPIC = "off_topic"
    # The student disclosed distress, harm or a serious personal difficulty. Not schoolwork,
    # and not misbehaviour either: it is answered with care, never counted as an off-topic
    # attempt, and never written into the discipline record. See docs/security.md.
    WELFARE = "welfare"
