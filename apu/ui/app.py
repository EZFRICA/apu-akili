"""APU Akili: demo interface (Streamlit, multipage).
...
st.set_page_config(page_title="APU Akili", page_icon="🎓", layout="wide")

from apu.ui import common  # noqa: E402

common.inject_css()
common.inject_accessibility()

with st.sidebar:
    st.markdown("## 🎓 Akili")
    st.caption("Agent Processor Unit · a tutor for schools")
