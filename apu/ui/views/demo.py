...
st.markdown(
    ...
    "4. **Voice → voice**, then **Braille → braille** → spoken answer, grade 2 braille, BRF file.\n"
    "5. “Save the key points of your answer” → saved to the notebook; **📓 Notebook** → braille sheet from "
    "chosen entries or a summary written by the tutor model.\n"
    "6. **prof-kouassi** → Aya's escalation, clusters, “Mark as resolved”.\n"
    "7. Access control → a class from another school is refused; **admin-cocody** sees 3eA and 4eB.\n\n"
    "Details: `DEMO.md`."
)
